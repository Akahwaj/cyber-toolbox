...
def run_teach_mode():
    ...
    if "password" in task:
        print("\n[Teach Mode]")
        print("This tool checks password strength and helps explain why a password is weak or strong.")
        try:
            password_tool()
        ...
        print("\n[Teach Mode]")
        print("Wireless Toolkit is planned as part of the group and will plug into this menu.")
